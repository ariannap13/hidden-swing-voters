...
# Load the data
with open('../../../data/00_raw_data/tweets_vips.json') as f:
    tweets_vips = json.load(f)

representatives_handles = pd.read_csv('../../../data/00_raw_data/twitter_representatives_handles_final.csv')
...
# save json file
with open('../../../data/00_raw_data/tweets_vips_party.json', 'w') as f:
